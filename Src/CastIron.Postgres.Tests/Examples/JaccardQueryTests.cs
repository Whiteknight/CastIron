...
CREATE UNIQUE INDEX RelationsDocumentTerm
...
SELECT
    *
    ...
    OFFSET 
        ...
        {
            // TODO: This
            Assert.Inconclusive("Posgres is returning an error message that I can't figure out");
