...
namespace CastIron.Sql.Tests.Mapping
{
    ...
    public class SimpleSelectTests
    {
        ...
        [Test]
        public void TestQuery_DictionaryOfCustomObject([Values("MSSQL", "SQLITE")] string provider)
        {
            var target = RunnerFactory.Create(provider);
        ...
        [Test]
        public void TestQuery_IDictionaryOfCustomObject([Values("MSSQL", "SQLITE")] string provider)
        {
            var target = RunnerFactory.Create(provider);
        ...
        [Test]
        public void TestQuery_IReadOnlyDictionaryOfCustomObject([Values("MSSQL", "SQLITE")] string provider)
        {
            var target = RunnerFactory.Create(provider);
        ...
        [Test]
        public void TestQuery_ObjectWithChildDictionary([Values("MSSQL", "SQLITE")] string provider)
        {
            var target = RunnerFactory.Create(provider);
