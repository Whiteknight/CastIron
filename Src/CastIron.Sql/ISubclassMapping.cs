...
namespace CastIron.Sql
{
    ...
    public interface ISubclassMapping<in TParent>
    {
        ...
        /// order in which they are configured. Once the subclass type is selected, the provided mapping
        /// (or a default mapping generated by the default mapper compiler) will map matching rows to
        /// the provided type
        /// </summary>
        ...
        /// <returns></returns>
        ISubclassMapping<TParent> UseSubclass<T>(Func<IDataRecord, bool> determine, Func<IDataRecord, TParent> map = null)
            where T : TParent;
        ...
        /// <param name="map"></param>
        /// <returns></returns>
        ISubclassMapping<TParent> Otherwise<T>(Func<IDataRecord, TParent> map = null)
            where T : TParent;
        ...
        /// <summary>
        /// If no predicates map, use a default value if possible
        /// </summary>
        /// <returns></returns>
        ISubclassMapping<TParent> OtherwiseDefault();
    }
}